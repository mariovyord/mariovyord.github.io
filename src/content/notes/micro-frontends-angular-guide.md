...
Think of microservices and you will suffer.
2. Share UI (or Suffer CSS Hell)
CSS encapsulation sounds nice until it doesn't.
There is no perfect solution here. Shadow DOM helps… until it doesn't. Global styles help… until somebody brings his override hack to the party.
Your best bet:
...
Unless you really need isolation (and somebody will try to convince you in that), just align Angular versions and move on.
...
If you don't plan this: relative paths fail.
Solution: Serve assets from a CDN
...
Encapsulation is possible… but do you really want to go there?
7. Use a Monorepo
Just do it.
...
Tight coupling
A distributed monolith tangled in its own guts.

Also:
Too many shared libs = hidden dependencies = slower development

Aim for: Independent, meaningful domains
Not LEGO pieces.
Final Thought
...
Treat them like: One system, split by domain, sharing a runtime
